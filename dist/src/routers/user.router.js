...
userRouter.post('/login', blockUserLogged_1.default, user_middleware_1.default.authenticate('local', { session: true, failureRedirect: '/login' }), home_controller_1.default.getHomePage);
